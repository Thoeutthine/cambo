"""
Problem 15: Find First and Last Position
Difficulty: Hard

Find range of target in array
...
if __name__ == "__main__":
    test_find_first_and_last_position()