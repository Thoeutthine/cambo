"""
Problem 46: Reverse Words in a String
Difficulty: Hard
...
def test_reverse_words_in_a_string():
    ...
    # Example: assert reverse_words_in_a_string() == blue is sky the
...
if __name__ == "__main__":
    test_reverse_words_in_a_string()